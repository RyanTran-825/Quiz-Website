...
const continueBtn = document.querySelector(".conti-btn");
...
function showQuestions(index) {
  ...
  questionText.textContent = `${questions[index].numb1}. ${questions[index].question}`;
...
function showResultBox() {
  ...
  scoreText.textContent = `Điểm của cưng được ${userScore} trên ${questions.length}`;
  ...
  let progress = setInterval(() => {
    ...
    circularProgress.style.background = `conic-gradient(#f25ea3 ${
      progressStartValue * 3.6
    }deg, rgba(52, 53, 53, 0.985) 0deg)`;
